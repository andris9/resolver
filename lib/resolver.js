...
function detectFileParams(meta){
    var urlparts = urllib.parse(meta.finalUrl),
        ...
        contentType = (meta.responseHeaders['content-type'] || "application/octet-stream").toLowerCase().split(";").shift().trim(),
        fileParts,
        extension = "",
        contentExtension;
